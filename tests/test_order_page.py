...
class TestOrder:
    ...
    def test_total_counter_increases(self, logged_in_browser):
        ...
        page.go_to_feed_js()
        updated_text = page.wait_for_text_change(page.locators.TOTAL_ORDERS_COUNT,initial_text,timeout=10)
    ...
    def test_today_counter_increases(self, logged_in_browser):
        ...
        self.create_order(page)
        page.go_to_feed_js()
        updated_text = page.wait_for_text_change(page.locators.TODAY_ORDERS_COUNT,initial_text,timeout=10)
        updated = int(updated_text)
